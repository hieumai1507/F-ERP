...
const HomeScreen = (props) => {
  ...
  >
      ...
      <StyledView className="flex-1 mx-5 my-8">
        ...
        <StyledView className="flex-row items-center mb-5">
          ...
          <StyledView className="ml-3">
            <StyledText className="text-white text-lg font-rmono">{user.name}</StyledText>
            <StyledText className="text-white text-base "> {user.department == '' ||
                  user.department == undefined ||
                  user.department == null
                    ? ''
                    : user.department}</StyledText>
          </StyledView>
          <SimpleLineIcons name="bell" size={24} color="white" style={{ marginLeft: 'auto' }} />
      </StyledView>
      ...
      <StyledView className="bg-white rounded-lg p-4 shadow-md">
        ...
        <StyledText className="text-lg font-bold mt-3 text-gray-800"> {user.department == '' ||
                  user.department == undefined ||
                  user.department == null
                    ? ''
                    : user.department}</StyledText>
